...
send(msg.chat_id,msg.id,"↯︙اهلا بك عزيزي في مصنع بوتات ‹ تيكساس ›
↯︙لحمايه الكروبات ومميزات خدميه اخرى
↯︙اصنع بوتك ورفعَ مشرف ودز تفعيل
↯︙سيتم رفع الادمنيه ومالك الكروب تلقائيا","html",true, false, false, true, reply_markup)
return false 
end
---making user
...
local TestText = ". 𝖻𝖺𝗊𝖾𝗋 .\n— — — — — — — — —\n ❍*َname 𝖻𝖺𝗊𝖾𝗋➢* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n❍*َbio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '. 𝖻𝖺𝗊𝖾𝗋 .', url = "https://t.me/RHHPP"}
},
}
...
{
{text = '‹ ѕᴏᴜʀᴄ ᴛᴇхᴀѕ ›', url = "https://t.me/L6L6P"},
},
}
local msg_id = msg.id/2097152/0.5 
...
{
{text = '‹ 𝗌𝗈𝗎𝗋𝖼𝖾 › T𝖾𝗑𝖺𝗌 ›', url = 't.me/L6L6P'}, 
},
}
